...
Отформатируй текст конспекта красиво, 
*** БАЗА ЗНАНИЙ ***
...
Для каждого упражнения обязательно приведи ссылку на источник, **обязательно укажи номер страницы и/или раздел**, если это возможно.
