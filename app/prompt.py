...
Занятие должно быть выстроено в игровом формате и иметь захватывающий внутренне-согласованный сценарий.

В помощь тебе база знаний - здесь много речевого материала, заданий, упражнений.
Обязательно используй этот материал - если ты не ссылаешься на него, то конспект не считается правильным и в этом случае вместо конспекта напиши "не получилось". 
