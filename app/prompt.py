...
В конспекте должны быть учтены все параметры занятия, которые прилагаются.
...
Отформатируй текст конспекта красиво чтобы
*** БАЗА ЗНАНИЙ ***
...
Для каждого упражнения обязательно приведи ссылку на источник, а также **попробуй как-нибудь определить и привести рядом раздел и/или страницу откуда взято**.
