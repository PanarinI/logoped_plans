...
Конспект должен быть обязательно выстроен вокруг упражнений из базы знаний.
В тексте **обязательно должны быть ссылки** на используемые источники.
Но если запрос такой, что в материалах ничего не находится - сообщи об этом и не составляй план.
Конспект должен быть составлен так, что "взял и проводи занятие" - все упражнения с речевым материалом и указаниями должны находиться в конспекте.
