        ...
        with gr.Row():
            ...
            with gr.Column(elem_classes=["left-col"], scale=1):
                ...
                with gr.Column(variant="panel"):  # <<< Обертка для второго блока
                    ...
                    количество_детей = gr.Slider(label="Количество детей в группе", minimum=2, maximum=10, value=2,
                    ...
                    длительность = gr.Slider(label="Длительность занятия (мин)", minimum=15, maximum=60, value=30,
                                             step=5)
